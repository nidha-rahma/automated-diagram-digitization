...
def preprocess_image(image_path, output_dir="outputs", show=True, save=True):
    # Read image
    ...
    print("✅ Preprocessing completed for:", image_path)
...
preprocess_image("../../flowchart_test_images/2sum.png")